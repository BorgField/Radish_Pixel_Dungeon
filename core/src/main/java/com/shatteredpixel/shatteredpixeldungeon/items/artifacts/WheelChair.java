...
public class WheelChair extends Artifact {
        ...
        public void onSelect(Integer target) {
            if (target != null && (Dungeon.level.visited[target] || Dungeon.level.mapped[target])){
                ...
                if (distance > 2+0.2*level()) {
                    GLog.w(Messages.get(WheelChair.class, "out_of_range"));
                    return;
                }
                ...
                hero.sprite.jump(hero.pos, cell, new Callback() {
                    ...
                    public void call() {
                        ...
                        Buff.prolong( hero, Stamina.class, (10+level()));
                        Invisibility.dispel();
    ...
    public class wheelRecharge extends ArtifactBuff {
        @Override
        public boolean act() {
            ...
            if (charge < chargeTarget
                ...
                //80-charge*2-level
                float chargeGain = (1 / (80f- level()- charge));
